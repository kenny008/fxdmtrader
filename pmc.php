...
<div id="divi">
<div id="div3">
<p><a href="ibc.php?IBRefrenceNumber=<?php echo $_GET['IBRefrenceNumber']?>.php">Introducing Brokers</a></p>
</div>
<div id="div4">
</div>

<div id="div5">
<p><a href="wlc.php?IBRefrenceNumber=<?php echo $_GET['IBRefrenceNumber']?>.php">White Labels</a></p>
</div>
<div id="divv6">
</div>
...
<div id="div5">
<p><a href="pmc.php?IBRefrenceNumber=<?php echo $_GET['IBRefrenceNumber']?>"><font color="#03B9E8">Portfolio Managers</font></a></p>
</div>
...
<div id="div8">
<p>FXDM's Multi Account Manager (MAM) software offers professional traders of multiple accounts and asset managers with an ideal solution to manage several MetaTrader 4 (MT4) trading accounts simultaneously. The main features of the FXDM MAM solution are:</p>
</div>
<div id="ourcpt">

<ul>
<li>Unlimited trading accounts.</li>
<li>3 allocation methods – Percentage, Proportional Equity or Lot.</li>
<li>STP order execution for instant allocation to sub accounts.</li>
<li>Stop Loss, Take Profit & Pending order functionality.</li>
<li>Trade Standard, Mini and Micro Lot accounts for precise position allocation.</li>
<li>All Forex Expert Advisor (EA) trading accepted (apart from unethical trading)</li>
<li>Partial close of positions facility available</li>
<li>Live risk and order management</li>
</ul>

<p>We recommend the FXDM MAM solution for partners who wish to:</p>
<p>&nbsp;</p>
<ul>
<li>Manage and trade multiple accounts simultaneously</li>
<li>Overview open trades, balances and margin levels for their accounts</li>
</ul>
</div>
