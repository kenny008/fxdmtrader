...
$to="sales.institutional@fxdmtrader.com";
	...
	$header="\n";
	$message="PARTNERSHIP REGISTRATION"."\n"."\n";
	...
	echo '<script type="text/javascript">
        window.alert("Thanks for registering in Partnership, you will be contacted as soon as possible.")
        </script>';
	}
	else{
...
echo"</li>";
echo"<li><a href=\"patnc.php?IBRefrenceNumber={$_GET['IBRefrenceNumber']}\"><font color=\"#03B9E8\">PARTNERSHIP</font></a>";
echo"<ul>";
echo"<li>";
...
<div id="div5">
<p><a href="wlc.php?IBRefrenceNumber=<?php echo $_GET['IBRefrenceNumber']?>">White Labels</a></p>
</div>
<div id="div6">
</div>
...
<div id="div7">
<p>IB REBATES</p>
<img src="images/banner-partnership.jpg" width="600" height="180" />
</div>
<div id="div8">
<p>FXDM's Introducing Broker (IB) program allows Individuals and Organizations to get compensated for introducing clients to FXDM. We take care of all the administration and back-end allowing you our IB to focus on what you know doing best – Referring clients </p>
</div>
<div id="ourc">
...
<tr><td>&nbsp;<td><td>&nbsp;<td></tr>
<tr><td colspan="2"><input type="submit" value="Submit"  id="stta" name="stta"/><td></tr>
</table>
</form>
</div>
</div>
