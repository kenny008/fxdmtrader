...
?>
<form action="https://www.moneybookers.com/app/payment.pl" method="post" target="_blank" name="" id="emaf">
<p><input type="hidden" name="pay_to_email" value="operations@fxdmtrader.com"></p>
<p><input type="hidden" name="status_url" value="operations@fxdmtrader.com"></p>
<p><input type="hidden" name="language" value="EN"></p>
<p><input type="hidden" name="amount" value="<?php   echo"{$res['ap']}"?>"></p>
<p><input type="hidden" name="currency" value="<?php   echo"{$res['BN']}"?>"></p>
<p><input type="hidden" name="detail1_description" value="DEPOSIT FUND"></p>
<p><input type="hidden" name="detail1_text" value="DEPOSIT FUND"></p>
<p><input type="hidden" name="confirmation_note" value="FXDM Trader"></p>
<?php
if($res['ap']==null OR $res['ap']==0){
echo"<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href=\"enta.php\">Click here to enter your intended deposit</a></p>";
}
else{
	echo"<p><input type=\"submit\" value=\"DEPOSIT FUND\" id=\"st2\">&nbsp;&nbsp;&nbsp;<a href=\"enta.php\">Edit Deposit</a></p>";
}
?>
