...
if(isset($_POST['submax'])){
	header("Location:log.php?account=lite");
	exit;
}
else if(isset($_POST['submax2'])){
	header("Location:log.php?account=gold");
	exit;
}
else if(isset($_POST['submax3'])){
	header("Location:log.php?account=platinum");
	exit;
}
?>
...
$(document).ready(function(){
	$("#divhelken").show();
  $(document).ready(function() {
    $('#div88').click(function() {
            $('#divhelken').slideToggle("slow");
    });
});
});
</script>
...
$(document).ready(function(){
	$("#divhelaken").show();
  $(document).ready(function() {
    $('#div8a').click(function() {
            $('#divhelaken').slideToggle("slow");
    });
});
});
</script>
...
$(document).ready(function(){
	$("#divhelbken").show();
  $(document).ready(function() {
    $('#div8b').click(function() {
            $('#divhelbken').slideToggle("slow");
    });
});
});
</script>
...
echo"</ul>";
echo"</li>";
echo"<li><a href=\"act.php\"><font color=\"#03B9E8\">ACCOUNTS</font></a>";
...
<div id="we">
<div id="stat">
<p><font color="#0067ac">FXDM Trading Accounts</font></p>
<img src="images/actf.png" width="900" height="320" />
</div>
<div id="stat2">
<P>

<div id="div88">
<p><img src="images/arrow.png" width="25" height="25" /><b> FXDM LITE</b></p>
<div id="divhelken">
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;FXDM LITE is designed for traders who are new to the Forex market. FXDMLITE account gives traders ample opportunity to &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;trade smaller lot sizes and an initial deposit as low as $50. 
</div>
</div>
<div id="div8a">
<p><img src="images/arrow.png" width="25" height="25" /><b> FXDM GOLD</b></p>
<div id="divhelaken">
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;FXDM Gold is designed for experienced traders. FXDM Gold gives traders excellent trading conditions with include a no &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;requotes. 
</div>
</div>
<div id="div8b">
<p><img src="images/arrow.png" width="25" height="25" /><b> FXDM PLANTINUM</b></p>
<div id="divhelbken">
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;FXDM PLATINUM is designed for high volume traders who are looking for excellent trading condition and tight spreads
</div>
</div>
...
<div id="scrap">
<div id="scrap4">
<p>Accounts Types<br /><BR /><br /><font size="-1" style="font-weight:bold " color="#333333" face="Tahoma, Geneva, sans-serif">Trading Platform:<br /><br /><br />Spreads:<br /><br /><br />Trading Instruments:<br /><br /><br />Floating Speed:<br /><br /><br />Leverage:<br /><br /><br />Execution:<br /><br /><br />Mininum Opening Deposit:<br /><br /><br />Minimum Trade Size:<br /><br /><br />Trade Size Increameant:<br /><br /><br />Maximum Total Trade Size:<br /><br /><br />Account Currency:<br /><br /><br />Commission:<br /><br /><br />Requotes:</font></p>
</div>
<div id="scrap1">
<p>FXDM Lite<br /><BR /><br /><font size="-1"  color="#00852a" face="Tahoma, Geneva, sans-serif">MetaTrader 4<br /><br /><br />2.8pips<br /><br /><br />Forex, Metals and Oil<br /><br /><br />Yes<br /><br /><br />1:200<br /><br /><br />Market Execution<br /><br /><br />USD 50<br /><br /><br />0.01 lot<br /><br /><br /> 0.01<br /><br /><br />100 Standard lots<br /><br /><br />USD, EUR<br /><br /><br />No<br /><br /><br />No</font></p><br /><form action="" method="post">
<input type="submit" name="submax" id="submax" value="Open Account" />
</form>
</div>
<div id="scrap2">
<p>FXDM Gold<br /><BR /><br /><font size="-1"  color="#0067ac" face="Tahoma, Geneva, sans-serif">MetaTrader 4<br /><br /><br />2.6pips<br /><br /><br />Forex, Metals and Oil<br /><br /><br />Yes<br /><br /><br />1:200<br /><br /><br />Market Execution<br /><br /><br />USD 250<br /><br /><br />0.01 lot<br /><br /><br /> 0.01<br /><br /><br />100 Standard lots<br /><br /><br />USD, EUR<br /><br /><br />No<br /><br /><br />No</font></p><br /><form action="" method="post">
<input type="submit" name="submax2" id="submax2" value="Open Account" />
</form>
</div>
<div id="scrap3">
<p>FXDM Plantinum<br /><BR /><br /><font size="-1"  color="#00852a" face="Tahoma, Geneva, sans-serif">MetaTrader 4<br /><br /><br />0.8pips<br /><br /><br />Forex, Metals and Oil<br /><br /><br />Yes<br /><br /><br />1:200<br /><br /><br />Market Execution<br /><br /><br />USD 500<br /><br /><br />0.01 lot<br /><br /><br /> 0.01<br /><br /><br />100 Standard lots<br /><br /><br />USD, EUR<br /><br /><br />Yes<br /><br /><br />No</font></p><br /><form action="" method="post">
<input type="submit" name="submax3" id="submax" value="Open Account" />
</form>
</div>
