...
<div id="div5">
<p><a href="regc.php?IBRefrenceNumber=<?php echo $_GET['IBRefrenceNumber']?>"><font color="#03B9E8">Regulation & Safety of Funds</font></a></p>
</div>
<div id="divv6">
</div>
<div id="div5">
...
<div id="div7">
<p>REGULATION OF FUNDS</p>
<img src="images/reg-banner.jpg" width="600" height="166" />
</div>
<div id="div8">
<p>FXDM Financial services limited (FXDM) is an Authorized online forex broker regulated by the New Zealand Financial Providers Registrar (FSPR) as a Financial Services provider (FSP) and is mandated to adhere to strict regulation and financial standards spelled out under New Zealand law.</p>
</div>
<div id="ourcc">
