...
echo"<li><a href=\"etc.php?IBRefrenceNumber={$_GET['IBRefrenceNumber']}\"><font color=\"#03B9E8\">EDUCATION & TOOLS</font></a>";
echo"<ul>";
echo"<li>";
...
<div id="divi">
<div id="div3">
<p><a href="wec.php?IBRefrenceNumber=<?php echo $_GET['IBRefrenceNumber']?>">Webinar</a></p>
</div>
<div id="div4">
</div>

<div id="div5">
<p><a href="lmac.php?IBRefrenceNumber=<?php echo $_GET['IBRefrenceNumber']?>">Live Market Analysis</a></p>
</div>
...
<div id="div7">
<p>Education and Tools</p>
<img src="images/banner-education.jpg" width="600" height="199" />
</div>
<div id="div8">
<p><b>FXDM Webinars</b><br />Our FX Webinars are designed to help traders get on well with the trading, providing daily market live analysis and teaching topics that are relevant to various traders' methods <br /><br /><br /><b>Live Market Analysis</b><br />This is another value innovative service rendered by FXDM to its esteemed clients. 0700-0900(GMT) daily, FXDM and its team of experts analyse the forex market, looking at the Majors and metals.</p>
</div>
<div id="ourc">
