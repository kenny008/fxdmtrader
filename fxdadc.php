...
$(document).ready(function(){
	$("#divhelc").show();
  $(document).ready(function() {
    $('#div8c').click(function() {
            $('#divhelc').slideToggle("slow");
    });
});
});
</script>
...
$(document).ready(function(){
	$("#divheld").show();
  $(document).ready(function() {
    $('#div8d').click(function() {
            $('#divheld').slideToggle("slow");
    });
});
});
</script>
...
$(document).ready(function(){
	$("#divhele").show();
  $(document).ready(function() {
    $('#div8e').click(function() {
            $('#divhele').slideToggle("slow");
    });
});
});
</script>
...
$(document).ready(function(){
	$("#divhelf").show();
  $(document).ready(function() {
    $('#div8f').click(function() {
            $('#divhelf').slideToggle("slow");
    });
});
});
</script>
...
<div id="div5">
<p><a href="fxdadc.php?IBRefrenceNumber=<?php echo $_GET['IBRefrenceNumber']?>"><font color="#03B9E8">FXDM Advantage</font></a></p>
</div>
<div id="divv6">
</div>
...
<div id="div5">
<p><a href="busmodelc.php?IBRefrenceNumber=<?php echo $_GET['IBRefrenceNumber']?>">Our Business Model</a></p>
</div>
<div id="div6">
</div>
<div id="div5">
...
<div id="div7">
<p>FXDM ADVANTAGE</p>
<img src="images/stands.png"  width="600" height="180"/>
</div>

<div id="div88">
<p><img src="images/arrow.png" width="25" height="25" /><b> NO DEALING DESK</b></p>
<div id="divhel">
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Our No-Dealing-Desk and No-requotes on execution for all Forex and commodities trades eliminates &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;dealer intervention, conflict of interest and the risk of price manipulation.
</div>

</div>
<div id="div8a">
<p><img src="images/arrow.png" width="25" height="25" /><b> REGULATED BROKER</b></p>
<div id="divhela">
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;FXDM is regulated by FSPR New Zealand and our Registration number is 4634719
</div>
</div>
<div id="div8b">
<p><img src="images/arrow.png" width="25" height="25" /><b> COMPETITIVE SPREADS</b></p>
<div id="divhelb">
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Our spreads are highly competitive and floating, which reflect the inter-banks movements.
</div>
</div>
<div id="div8c">
<p><img src="images/arrow.png" width="25" height="25" /><b> EXECUTION SPREAD</b></p>
<div id="divhelc">
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Execution on orders is at the speed of thoughts.
</div>
</div>
<div id="div8d">
<p><img src="images/arrow.png" width="25" height="25" /><b> FREE MOBILE TRADER</b></p>
<div id="divheld">
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Never miss any opportunity with FXDM mobile apps for your mobile devices which include android based &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;phone, Ipads and Iphones
</div>
</div>
<div id="div8e">
<p><img src="images/arrow.png" width="25" height="25" /><b> LIVE MARKET ANALYSIS</b></p>
<div id="divhele">
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;One of the best ways to learn how to do anything is to watch the professionals who got the knowledge, &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;skills, experience and expertise in action. FXDM has brought to its esteemed clients the ability to interact &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;with professionals in a live online classroom, allowing them to learn various trading topics, how the &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;market is analyzed to take its full advantage and ask them question specific to their trading methods.
</div>
</div>
<div id="ourc1">
