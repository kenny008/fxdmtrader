...
if(isset($_POST['submax'])){
	header("Location:lregister.php?IBRefrenceNumber={$_GET['IBRefrenceNumber']}");
	exit;
}
...
echo"</ul>";
echo"</li>";
echo"<li><a href=\"actc.php?IBRefrenceNumber={$_GET['IBRefrenceNumber']}\"><font color=\"#03B9E8\">ACCOUNTS</font></a>";
