...
<link rel="stylesheet" media="screen and (min-width: 100px) and (max-width: 1300px)" href="stylesheets/dash2.css" />
 <link href="jsl/jquery-ui.js/1.8/themes/base/jquery-ui.css" rel="stylesheet" type="text/css"/>
  <script src="jsl/jquery.js"></script>
...
function bounceDiv() {
    $('#sab44').effect("bounce", { times: 1 }, 300,function() {
    bounceDiv()
    });
}
  </script>
...
function bounceDivs() {
    $('#sab55').effect("bounce", { times: 1 }, 300,function() {
    bounceDivs()
    });
}
  </script>
...
function kenny(){
var kan=document.getElementById("firsts").value;	
var kao=" USD";
var tyu=document.getElementById("curen").value;
var kan2=kan*tyu;
var kan3=kan2;
var hey=document.getElementById("fsecs");
hey.value=kan3;
}
function kan(){
	firsts.value=" ";
...
<div id="edt">
<img src="images/fx.png" height="40" width="40" /><p>Foreign Exchange</p>
</div>
...
<div id="sabken">
<p>Naira Exchange rate to Dollar</p>
</div>
</div>
