...
<div id="divi">
<div id="div3">
<p><a href="ibc.php?IBRefrenceNumber=<?php echo $_GET['IBRefrenceNumber']?>">Introducing Brokers</a></p>
</div>
<div id="divv4">
</div>

<div id="div5">
<p><a href="wlc.php?IBRefrenceNumber=<?php echo $_GET['IBRefrenceNumber']?>"><font color="#03B9E8">White Labels</font></a></p>
</div>
<div id="divv6">
</div>
...
<div id="div5">
<p><a href="pmc.php?IBRefrenceNumber=<?php echo $_GET['IBRefrenceNumber']?>">Portfolio Managers</a></p>
</div>
...
<div id="div7">
<p>WHITE LABEL</p>
<img src="images/automated-trading-banner.png" width="600" height="180" />
</div>

<div id="div8">
<p>Forex White Labels are ideal for licensed financial institutions looking to expand their retail online-trading business. FXDMTrader offers the total White Label Forex Broker Solution. This is built around customised versions of our award winning trading platforms, like our Metatrader 4 download, under the FX White Label Client´s name. Our services include re-branding and customising the platform to your exact requirements whilst providing comprehensive added-value support services to you and your client base. </p>
</div>
<div id="ourc">
<p>FXDMTrader White Label offers you</p>
<ul>
<li>Integrated front and back office infrastructure.</li>
<li>Aggregated liquidity from Tier 1 banks.</li>
<li>Award winning platforms.</li>
<li>Multi currency denominated accounts.</li>
<li>Dedicated 24 hour support</li>
</ul>

</div>
<div id="div8">
<p>We can offer a wealth of opportunities to grow your business, broaden your client base and enhance your reputation. To find out how to partner with FXDMTrader, please complete our partnership contact form below. You can also email us at info@fxdmtrader.com .. </p>
</div>
<div id="riw">
