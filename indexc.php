...
<?php
if(isset($_POST['cl2'])){
	header("Location:whyfxdc.php?IBRefrenceNumber={$_GET['IBRefrenceNumber']}");
	exit;
}
...
if(isset($_POST['live'])){
	...
	header("Location:demoac.php?IBRefrenceNumber={$_GET['IBRefrenceNumber']}");
	exit;
}
else if(isset($_POST['oacc'])){
header("Location:act.php?IBRefrenceNumber={$_GET['IBRefrenceNumber']}");
exit;	
}
...
$(document).ready(function(){
	$("#kane").click(function(){
	location.href="http://www.fxdmtrader.com/regc.php?IBRefrenceNumber=<?php echo $_GET['IBRefrenceNumber']?>";
	 });
	  });
</script>
<script type="text/javascript">
$(document).ready(function(){
	...
	location.href="http://www.fxdmtrader.com/mobtc.php?IBRefrenceNumber=<?php echo $_GET['IBRefrenceNumber']?>";
	 });
	  });
</script>
<script type="text/javascript">
$(document).ready(function(){
	...
	location.href="http://www.fxdmtrader.com/ibc.php?IBRefrenceNumber=<?php echo $_GET['IBRefrenceNumber']?>";
	 });
	  });
</script>
<script type="text/javascript">
$(document).ready(function(){
	...
	location.href="http://www.fxdmtrader.com/pmc.php?IBRefrenceNumber=<?php echo $_GET['IBRefrenceNumber']?>";
	 });
	  });
</script>
<script type="text/javascript">
...
echo"<div id=\"nav1\">";
echo"<ul id=\"d\">";
echo"<li><a href=\"indexc.php?IBRefrenceNumber={$_GET['IBRefrenceNumber']}\"><font color=\"#03B9E8\">HOME</font></a></li>";
...
<li data-transition="slide" data-slotamount="1" data-masterspeed="300" data-thumb="images/thumbs/thumb5.jpg" style="visibility: visible; left: 0px; top: 0px; z-index: 18; opacity: 1;">
									...
									<div class="slotholder"><img src="images/forex-banner-4(2).jpg" class="defaultimg" style="width: 960px; height: 350px; opacity: 0;"></div>
